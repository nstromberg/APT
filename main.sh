...
# PYARGS="$PYARGS --eval_data Moneyball.pt,airfoil_self_noise.pt,concrete_compressive_strength.pt,energy_efficiency.pt,forest_fires.pt,solar_flare.pt,student_performance_por.pt,QSAR_fish_toxicity.pt,red_wine.pt,socmob.pt,cars.pt"
...
PYARGS="$PYARGS --max_class_size 26"
